...
do-not = "don't" # A variable storing a string
...
print("I said: {x}") # Prints f-string that contains a variable
pirnt(f"I also said: '{y}'") # Prints f-string that contails a variable 
...
print(joke_evaluation.fmt(hilarious)) # Printing both variables
